...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_REP_CREATURE_EQUIP_TEMPLATE,
    WORLD_UPD_CREATURE_TEMPLATE_NAME,
    WORLD_UPD_CREATURE_TEMPLATE_SUBNAME,
    WORLD_UPD_CREATURE_TEMPLATE_MODEL,
    WORLD_UPD_CREATURE_TEMPLATE_SCALE,
    WORLD_REP_CREATURE_TEMPLATE,
    WORLD_REP_CREATURE_TEMPLATE_MODEL,
